...
public class VCliente extends javax.swing.JFrame {
     ...
     */
    public VCliente() throws SQLException {
        initComponents();
        jPanel1.setBackground(new Color(0,0,0,195));
        setLocationRelativeTo(null);
        setResizable(false);
        
        
        cl.ShowDataCliente();
        cl.ShowDataBoxSearchCliente();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jbtn_MIn, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 0, 20, 30));
        ...
        jPanel1.add(txt_Cerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 0, 20, 30));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 770, -1));
        ...
        jPanel1.add(jbtn_home, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 30, 30));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 860, 60));
        ...
        jbtn_BuscarC.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/searcher2.png"))); // NOI18N
    ...
    private void btn_RegistrarCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_RegistrarCActionPerformed
        ...
        String dni = txt_DNIC.getText();
        String telefono = txt_TelefonoC.getText();
        String email = txt_Email.getText();
        
        try {
            cl.InsertCliente(dni, nombre, Apellidos, telefono, email);
